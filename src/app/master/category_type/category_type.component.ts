...
declare var $;
@Component({
  selector: 'app-category_type',
  templateUrl: './category_type.component.html',
  styleUrls: ['./category_type.component.scss']
})
export class CategoryTypeComponent implements OnInit {
  ...
  getCategoryType() {
    this.api
      .getAPI(environment.API_URL + "master/category_type")
      .subscribe((res) => {
        this.dataSource = new MatTableDataSource(res.data);
        this.catagorytype = res.data;
        this.dataSource.paginator = this.pagination;
        this.logger.log('country',this.catagorytype)
      });
  }
