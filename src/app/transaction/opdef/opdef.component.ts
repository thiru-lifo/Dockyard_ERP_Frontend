...
export class OPDEFComponent implements OnInit {
  ...
  public editForm = new FormGroup({
    id: new FormControl(""),
    OpdefDate: new FormControl("moment().format('MM/DD/yyyy')"),
    OpdefNo: new FormControl(""),
    ShipID: new FormControl(""),
    Command: new FormControl(""),
    DepartmentID: new FormControl("",[Validators.required]),
    DartNo: new FormControl(""),
    STA: new FormControl(""),
    ...
    AssistanceRequired: new FormControl(""),
    EffectOnOperation: new FormControl(""),
    DowngradeDate: new FormControl("moment().format('MM/DD/yyyy')"),
    STADowngradeDate: new FormControl("moment().format('MM/DD/yyyy')"),
    STAUpgradeDate: new FormControl("moment().format('MM/DD/yyyy')"),
    CancelDtg: new FormControl(""),
    CancelDate: new FormControl("moment().format('MM/DD/yyyy')"),
    RepairDate: new FormControl("moment().format('MM/DD/yyyy')"),

    RepairID: new FormControl(""),
    RepairParts: new FormControl(""),
    HoldupCode: new FormControl(""),
    HoldupDetail: new FormControl(""),
    INSMAEffort: new FormControl(""),
    Refit: new FormControl(""),
    Active: new FormControl(""),
    Remarks: new FormControl(""),
    StoredemSrNo: new FormControl(""),

    OpDefStatus: new FormControl(""),
    EquipmentSerialNo: new FormControl(""),
    status: new FormControl(""),

    OfarDate: new FormControl("moment().format('MM/DD/yyyy')"),
  ...
  getListing() {
    this.api
      .getAPI(environment.API_URL + "transaction/opdef")
      .subscribe((res) => {
        ...
        this.logger.log('opdef',res.data)
      });
   } 
  ...
  onDelete(data) {
    ...
    dialogRef.afterClosed().subscribe(result => {
      if(result) {
        this.api.postAPI(environment.API_URL + "transaction/opdef/crud", {
          id: data.id,
  ...
  onSubmit() {
    ...
    this.showError = true;
     if (this.editForm.valid) {
      ...
      this.api
        .postAPI(
          environment.API_URL + "transaction/opdef/crud",
          this.editForm.value
        )
        .subscribe((res) => {
          this.logger.log('response',res);
...
numberOnly(event:any): boolean {
  ...
  onSubmitImport() {
    ...
    this.api
      .postAPI(
        environment.API_URL + "transaction/opdef/excel",
        formData
      )
      .subscribe((res) => {
        this.logger.log('response', res);
