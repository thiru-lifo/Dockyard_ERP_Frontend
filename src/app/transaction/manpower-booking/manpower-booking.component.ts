...
@Component({
  selector: 'app-manpower-booking',
  templateUrl: './manpower-booking.component.html',
  styleUrls: ['./manpower-booking.component.scss']
})
export class ManpowerBookingComponent implements OnInit {
  ...
  public editForm = new FormGroup({
    ...
    time: new FormControl("moment().format('HH:mm:ss')"),

    center: new FormControl("",[Validators.required]),
    shop_floor: new FormControl("",[Validators.required]),
    status_master: new FormControl("",[Validators.required]),
    work_instruction: new FormControl("",[Validators.required]),
    job_card: new FormControl("",[Validators.required]),
    over_time: new FormControl("",[Validators.required]),
  ...
  getListing() {
    this.api
      .getAPI(environment.API_URL + "transaction/manpower-booking")
      .subscribe((res) => {
      ...
      if(result) {
        this.api.postAPI(environment.API_URL + "transaction/ra/crud", {
          ...
          if(res.status==environment.SUCCESS_CODE) {
            ...
            this.getListing();
            this.notification.warn('Dart '+language[environment.DEFAULT_LANG].deleteMsg);
  ...
  onSubmit() {
    ...
    // console.log(this.editForm.value,"ddd")
    // return false;
    ...
    this.showError = true;
     if (this.editForm.valid) {
      ...
      this.editForm.value.date = moment(this.editForm.value.date, "YYYY-MM-DD").format("YYYY-MM-DD");
      this.editForm.value.time = moment(this.editForm.value.time, "YYYY-MM-DD").format("YYYY-MM-DD");
      ...
      this.api
        .postAPI(
          environment.API_URL + "transaction/manpower-booking/crud",
          this.editForm.value
        )
        .subscribe((res) => {
          this.logger.log('response',res);
...
employees:any;
  ...
  getShopFloor() {
    this.api
      .getAPI(environment.API_URL + "master/shop_floor?status=1")
      .subscribe((res) => {
        this.shop_floors = res.data;
        console.log(this.shop_floors,"shop_floors")
      });
  }
  ...
  getStatusMaster() {
    this.api
      .getAPI(environment.API_URL + "master/status_master?status=1")
      .subscribe((res) => {
        this.status_masters = res.data;
        console.log(this.status_masters,"status_masters")
      });
  }
  ...
  getWorkInstruction() {
    this.api
      ...
      .subscribe((res) => {
        this.work_instructions = res.data;
        console.log(this.work_instructions,"work_instructions")
      });
  }
  ...
  getJobCard() {
    this.api
      .getAPI(environment.API_URL + "transaction/job-card?status=1")
      .subscribe((res) => {
        this.job_cards = res.data;
        console.log(this.job_cards,"job_cards")
      });
  }
  ...
  getOverTime() {
    this.api
      .getAPI(environment.API_URL + "master/over-time?status=1")
      .subscribe((res) => {
        this.over_times = res.data;
        console.log(this.over_times,"over_times")
      });
  }
