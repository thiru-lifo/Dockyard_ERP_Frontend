...
export class TemplateGenerationComponent implements OnInit {
  ...
  constructor(public api: ApiService, private notification : NotificationService,
    ...
    this.aroute.params.subscribe(routeParams => {
        ...
        this.p_id = this.aroute.snapshot.queryParamMap.get('pid');
        this.t_id = this.aroute.snapshot.queryParamMap.get('tid');
        
        //console.log(this.p_id,"datedatedate")
    });
  ...
  this.subModuleSelected = Number(this.PAGE_FORM_ID);
   ...
   this.getProcess();
    ...
    //     this.project_ID=this.p_id;
    //     this.getInitiationTemplate(this.p_id);
    //     openModal('#crud-countries');
    ...
    if(this.p_id!=null){
     ...
     let init = {tid:parseInt(this.t_id),pid:parseInt(this.p_id)}
        setTimeout(()=>{
          
          openModal('#crud-countries');
          this.editOption(init,'d')
        },5000);
    }
...
getProject(code) {
 ...
 param1:any;
  ...
  editOption(initiation,type) {
    ...
    this.project_ID=initiation.project.id;
        ...
        this.proid=initiation.pid;
        this.project_ID=initiation.pid;
        this.editID=initiation.tid;
  }
  //console.log(this.project_ID,"this.project_IDthis.project_IDthis.project_ID")
    ...
    setTimeout(()=>{this.project_ID=initiation.pid;},1500);
    this.getInitiationTemplate(initiation.pid);
  }
 ...
 onSubmitNew()
 {
  ...
  // //id:this.editID,module:this.PAGE_MODULE_ID,form:this.PAGE_FORM_ID,project_id: this.project_ID, psr:this.transaction, system:this.itemsSystemChild
  // console.log("id:",this.editID)
  // console.log("module:",this.PAGE_MODULE_ID)
  // console.log("form:",this.PAGE_FORM_ID)
  // console.log("project_id:",this.project_ID)
  // console.log("psr:",this.transaction)
  // console.log("system:",this.itemsSystemChild)
  // return false;
