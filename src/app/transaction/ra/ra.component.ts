...
export class RaComponent implements OnInit {
  ...
  public editForm = new FormGroup({
    ...
    ShipSrNo: new FormControl(""),
    DartDate: new FormControl("moment().format('MM/DD/yyyy')"),
    DepartmentID: new FormControl("",[Validators.required]),
    ExDept: new FormControl(""),
    ExDeptID: new FormControl(""),
    EquipmentShipID: new FormControl(""),
    EquipmentCode: new FormControl(""),
    SeverityID: new FormControl(""),
    SeverityCode: new FormControl(""),
    DiagnosticID: new FormControl(""),

    DiagnosticCode: new FormControl(""),
    RectifiedDate: new FormControl("moment().format('MM/DD/yyyy')"),
    RepairID: new FormControl(""),
    RepairCode: new FormControl(""),
    RepairAgencyID: new FormControl(""),
    AgencyCode: new FormControl(""),
    DelayID: new FormControl(""),
    DelayCode: new FormControl(""),
    Remarks: new FormControl(""),
    OpdefSrNo: new FormControl(""),
    XdueRefitType: new FormControl(""),
    XdueRefitRemarks: new FormControl(""),
    CancelDate: new FormControl("moment().format('MM/DD/yyyy')"),
    NILDart: new FormControl(""),
