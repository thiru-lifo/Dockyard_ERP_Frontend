...
export class JobCardComponent implements OnInit {
  ...
  public editForm = new FormGroup({
    ...
    job_card_close_date: new FormControl("moment().format('MM/DD/yyyy')"),
  ...
  getListing() {
    this.api
      .getAPI(environment.API_URL + "transaction/job-card")
      .subscribe((res) => {
  ...
  onSubmit() {
    ...
    this.showError = true;
     if (this.editForm.valid) {
      ...
      this.api
        .postAPI(
          environment.API_URL + "transaction/job-card/crud",
          this.editForm.value
        )
        .subscribe((res) => {
          this.logger.log('response',res);
