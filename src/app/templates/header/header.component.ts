...
export class HeaderComponent implements OnInit {
  ...
  navigateTo(notification)
  {
    ...
    {
      case 1:
        this.router.navigateByUrl('/transaction/psr/template-generation/1?tid='+transaction_id+'&pid='+project_id);
      break;
      case 2:
        this.router.navigateByUrl('/transaction/psr/gt-formulation-paper/2?tid='+transaction_id+'&pid='+project_id);
      break;
      case 3:
        this.router.navigateByUrl('/transaction/psr/gt-presentation-paper/3?tid='+transaction_id+'&pid='+project_id);
      break;
      case 4:
        this.router.navigateByUrl('/transaction/psr/gt-inputs-sr/4?tid='+transaction_id+'&pid='+project_id);
      break;
      case 5:
        this.router.navigateByUrl('/transaction/psr/gt-concept-design/5?tid='+transaction_id+'&pid='+project_id);
      break;
      case 6:
        this.router.navigateByUrl('/transaction/psr/gt-incorporation/6?tid='+transaction_id+'&pid='+project_id);
      break;
      case 7:
        this.router.navigateByUrl('/transaction/psr/gt-receipt-rfi/7?tid='+transaction_id+'&pid='+project_id);
      break;
    }
  }
