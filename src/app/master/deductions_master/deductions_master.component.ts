...
declare var $;
@Component({
  selector: 'app-deductions_master',
  templateUrl: './deductions_master.component.html',
  styleUrls: ['./deductions_master.component.scss']
})
export class DeductionsMasterComponent implements OnInit {
  ...
  ngOnInit(): void {
     this.getDeductionsMsater();
     this.getAccess();
  }
  deduction:any
  getDeductionsMsater() {
    this.api
      .getAPI(environment.API_URL + "master/deductions_master")
      .subscribe((res) => {
        this.dataSource = new MatTableDataSource(res.data);
        this.deduction = res.data;
        this.dataSource.paginator = this.pagination;
        this.logger.log('deductionsmaster',this.deduction)
      });
  }
  ...
  onDelete(id) {
    ...
    dialogRef.afterClosed().subscribe(result => {
      if(result) {
        this.api.postAPI(environment.API_URL + "master/deductions_master/details", {
          id: id,
          status: 3,
        }).subscribe((res)=>{
  ...
  onSubmit() {
     if (this.editForm.valid) {
      ...
      this.api
        .postAPI(
          environment.API_URL + "master/deductions_master/details",
          this.editForm.value
        )
        .subscribe((res) => {
          this.logger.log('response',res);
