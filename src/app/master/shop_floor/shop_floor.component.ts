...
@Component({
  ...
  templateUrl: './shop_floor.component.html',
  styleUrls: ['./shop_floor.component.scss']
})
export class ShopFloorComponent implements OnInit {
  ...
  public editForm = new FormGroup({
    ...
    dockyard_sub_group: new FormControl("",[Validators.required]),
...
dock_yard_sub_group:any;
  getDockyardSubGroup() {
    this.api
      .getAPI(environment.API_URL + "master/dockyard_sub_group?status=1")
      .subscribe((res) => {
        this.dock_yard_sub_group = res.data;
      });
  }
...
shop_floor:any
  getShopFloor() {
    this.api
      .getAPI(environment.API_URL + "master/shop_floor")
      .subscribe((res) => {
        this.dataSource = new MatTableDataSource(res.data);
        this.shop_floor = res.data;
        this.dataSource.paginator = this.pagination;
        this.logger.log('dockyardgroup',this.shop_floor)
      });
  }
  ...
  onDelete(id) {
    ...
    dialogRef.afterClosed().subscribe(result => {
      if(result) {
        this.api.postAPI(environment.API_URL + "master/shop_floor/details", {
          id: id,
          status: 3,
        }).subscribe((res)=>{
  ...
  onSubmit() {
     if (this.editForm.valid) {
      ...
      this.api
        .postAPI(
          environment.API_URL + "master/shop_floor/details",
          this.editForm.value
        )
        .subscribe((res) => {
          this.logger.log('response',res);
